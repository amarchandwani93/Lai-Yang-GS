...
public abstract class Orchestration {
    private Map<Long, Thread> processIDToThread = new HashMap<Long, Thread>();
    private Map<Long, Process> processIDToProcess = new HashMap<Long, Process>();
    private Map<Long, Channel> channelIDToChannel = new HashMap<Long, Channel>();
    ...
    public static class ProcessInitMeta {
        ...
        public ProcessInitMeta(int noOfProcesses) {
            ...
            this.initialValueList = new ArrayList<Long>(noOfProcesses);
        }
