...
public class LaiYangSnapshot implements Snapshot {
    ...
    public LaiYangSnapshot(long timestamp, Long localState, Long initiatorProcessID, Long totalNoOfProcesses) {
        ...
        this.computedProcessStateList  = new LinkedList<ComputedProcessStateBean>();

        this.initiator_channelID_MessagesSent = new HashMap<String, List<WhiteMessageLog>>();
        this.initiator_channelID_MessagesReceived = new HashMap<String, List<WhiteMessageLog>>();

        this.channelID_MessageSentToInitiator = new HashMap<String, List<WhiteMessageLog>>();
        this.channelID_MessageReceivedFromInitiator = new HashMap<String, List<WhiteMessageLog>>();
        this.otherProcessIDToLocalState = new HashMap<Long, Long>();
    }
